...
export class StompSockJSWebSocketService {
  ...
  private createStompClient(): Client {
    const config: StompConfig = {
      ...
      webSocketFactory: () => {
        const baseUrl = environment.enginesWebSocketUrl + '/ws/nse-indices-native';
