...
/**
 * Entity representing NSE Equity Master data.
 * Maps to nse_eq_master table in the database.
 * 
 * This is a copy of the entity from backend module for use in engines module.
