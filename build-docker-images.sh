...
# Config Server
build_docker_image "Config Server" "$project_root/config-server"

# Discovery Server
build_docker_image "Discovery Server" "$project_root/discovery-server"
...
# API Gateway
build_docker_image "API Gateway" "$project_root/api-gateway"
