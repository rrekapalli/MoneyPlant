...
import { Component, Input, CUSTOM_ELEMENTS_SCHEMA, ViewChild, EventEmitter, Output } from '@angular/core';
import { CompactType, DisplayGrid, GridType, GridsterComponent, GridsterItemComponent } from 'angular-gridster2';
...
import * as i3 from 'primeng/scrollpanel';
...
class EchartComponent {
    ...
    onClick(e) {
        ...
        setTimeout(() => {
            ...
            if (e.seriesType === "scatter") {
                const scatterChartData = e.data.find((item) => item.name === this.widget.config.state?.accessor);
                selectedPoint = {
                    ...selectedPoint,
                    ...scatterChartData
                };
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: EchartComponent, selectors: [["vis-echart"]], inputs: { widget: "widget", onDataLoad: "onDataLoad", onUpdateFilter: "onUpdateFilter" }, features: [i0.ɵɵProvidersFeature([provideEchartsCore({
                    echarts: () => import('echarts'),
                })])], decls: 1, vars: 2, consts: [["echarts", "", 3, "chartInit", "chartClick", "chartDblClick", "options", "initOpts"]], template: function EchartComponent_Template(rf, ctx) { if (rf & 1) {
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(EchartComponent, { className: "EchartComponent", filePath: "lib/widgets/echarts/echart.component.ts", lineNumber: 24 }); })();
...
class FilterComponent {
    ...
    set filterValues(values) {
        if (values && values.length > 0) {
            this.widget.config.options.values = values;
        }
    }
    ...
    clearFilter(item) {
        if (JSON.stringify(item).length > 0) {
            ...
            this.widget.config.options.values = this.filterValues;
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(FilterComponent, { className: "FilterComponent", filePath: "lib/widgets/filter/filter.component.ts", lineNumber: 14 }); })();

class TableComponent {
    static { this.ɵfac = function TableComponent_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || TableComponent)(); }; }
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TableComponent, selectors: [["vis-table"]], inputs: { widget: "widget", onDataLoad: "onDataLoad", onUpdateFilter: "onUpdateFilter" }, decls: 0, vars: 0, template: function TableComponent_Template(rf, ctx) { }, dependencies: [CommonModule], encapsulation: 2 }); }
}
...
class TileComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TileComponent, selectors: [["vis-tile"]], inputs: { widget: "widget", onDataLoad: "onDataLoad", onUpdateFilter: "onUpdateFilter" }, decls: 0, vars: 0, template: function TileComponent_Template(rf, ctx) { }, dependencies: [CommonModule], encapsulation: 2 }); }
}
...
class MarkdownCellComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: MarkdownCellComponent, selectors: [["vis-markdown-cell"]], inputs: { widget: "widget", onDataLoad: "onDataLoad", onUpdateFilter: "onUpdateFilter" }, decls: 0, vars: 0, template: function MarkdownCellComponent_Template(rf, ctx) { }, dependencies: [CommonModule], encapsulation: 2 }); }
}
...
class CodeCellComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: CodeCellComponent, selectors: [["vis-code-cell"]], inputs: { widget: "widget", onDataLoad: "onDataLoad", onUpdateFilter: "onUpdateFilter" }, decls: 0, vars: 0, template: function CodeCellComponent_Template(rf, ctx) { }, dependencies: [CommonModule], encapsulation: 2 }); }
}
...
const _c0$3 = ["react"];
class ReactComponentWrapperComponent {
    ...
    static { this.ɵfac = function ReactComponentWrapperComponent_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || ReactComponentWrapperComponent)(i0.ɵɵdirectiveInject(i0.ElementRef)); }; }
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ReactComponentWrapperComponent, selectors: [["app-react-component-wrapper"]], viewQuery: function ReactComponentWrapperComponent_Query(rf, ctx) { if (rf & 1) {
            i0.ɵɵviewQuery(_c0$3, 5);
        } if (rf & 2) {
            let _t;
            i0.ɵɵqueryRefresh(_t = i0.ɵɵloadQuery()) && (ctx.reactElement = _t.first);
        } }, inputs: { widget: "widget", onDataLoad: "onDataLoad", onUpdateFilter: "onUpdateFilter" }, decls: 2, vars: 1, consts: [[3, "widget"]], template: function ReactComponentWrapperComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵelementStart(0, "div");
            i0.ɵɵelement(1, "my-react-component", 0);
            i0.ɵɵelementEnd();
        } if (rf & 2) {
            i0.ɵɵadvance();
            i0.ɵɵproperty("widget", ctx.widget);
        } }, encapsulation: 2 }); }
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(ReactComponentWrapperComponent, [{
        type: Component,
        args: [{
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(ReactComponentWrapperComponent, { className: "ReactComponentWrapperComponent", filePath: "lib/widgets/react-wrapper/react-wrapper.component.ts", lineNumber: 30 }); })();

const _c0$2 = () => ({ height: "20vh" });
...
class WidgetComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: WidgetComponent, selectors: [["vis-widget"]], inputs: { widget: "widget" }, outputs: { onDataLoad: "onDataLoad", onUpdateFilter: "onUpdateFilter" }, features: [i0.ɵɵProvidersFeature([
                provideEchartsCore({
                    echarts: () => import('echarts'),
                })
            ])], decls: 2, vars: 5, consts: [[4, "ngComponentOutlet", "ngComponentOutletInputs"]], template: function WidgetComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵelementStart(0, "div");
            i0.ɵɵtemplate(1, WidgetComponent_ng_container_1_Template, 1, 0, "ng-container", 0);
            i0.ɵɵelementEnd();
        } if (rf & 2) {
            i0.ɵɵstyleMap(i0.ɵɵpureFunction0(4, _c0$2));
            i0.ɵɵadvance();
            i0.ɵɵproperty("ngComponentOutlet", ctx.currentWidget.component)("ngComponentOutletInputs", ctx.currentWidget.inputs);
        } }, dependencies: [NgComponentOutlet], encapsulation: 2 }); }
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(WidgetComponent, [{
        type: Component,
        args: [{ selector: 'vis-widget', standalone: true, imports: [NgComponentOutlet,
                    EchartComponent,
                    FilterComponent,
                    TableComponent,
                    TileComponent,
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(WidgetComponent, { className: "WidgetComponent", filePath: "lib/widgets/widget/widget.component.ts", lineNumber: 54 }); })();

const _c0$1 = () => ({ height: "85vh", width: "100%", "overflow-x": "hidden", "overflow": "auto" });
class WidgetConfigComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: WidgetConfigComponent, selectors: [["vis-widget-config"]], inputs: { selectedDashboardId: "selectedDashboardId", widget: "widget" }, outputs: { onUpdate: "onUpdate" }, decls: 11, vars: 7, consts: [["id", "panelId", 2, "height", "100%", "overflow-y", "visible"], [3, "ngSubmit", "formGroup"], [1, "form-buttons"], [1, "form-button"], ["type", "button", "label", "Save", 3, "click", "outlined"], ["type", "button", "label", "Edit", 1, "ui-button-warning", "ml-2", "mr-2", 3, "outlined"], ["type", "reset", "label", "Reset", 1, "ui-button-danger", 3, "outlined"], ["position", "bottom-right", "key", "br"]], template: function WidgetConfigComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵelementStart(0, "div", 0)(1, "p-scrollPanel")(2, "form", 1);
            i0.ɵɵlistener("ngSubmit", function WidgetConfigComponent_Template_form_ngSubmit_2_listener() { return ctx.onWidgetSave(); });
            i0.ɵɵelementEnd()();
            i0.ɵɵelementStart(3, "div", 2)(4, "div", 3)(5, "p-button", 4);
            i0.ɵɵlistener("click", function WidgetConfigComponent_Template_p_button_click_5_listener() { return ctx.onWidgetSave(); });
            i0.ɵɵelementEnd()();
            i0.ɵɵelementStart(6, "div", 3);
            i0.ɵɵelement(7, "p-button", 5);
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(8, "div", 3);
            i0.ɵɵelement(9, "p-button", 6);
            i0.ɵɵelementEnd()()();
            i0.ɵɵelement(10, "p-toast", 7);
        } if (rf & 2) {
            i0.ɵɵadvance();
            i0.ɵɵstyleMap(i0.ɵɵpureFunction0(6, _c0$1));
            i0.ɵɵadvance();
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(WidgetConfigComponent, { className: "WidgetConfigComponent", filePath: "lib/widget-config/widget-config.component.ts", lineNumber: 30 }); })();
...
function WidgetHeaderComponent_ng_template_1_Conditional_0_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function WidgetHeaderComponent_ng_template_1_Conditional_0_Template_p_button_click_0_listener($event) { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(2); return i0.ɵɵresetView(ctx_r1.onDeleteWidgetClicked($event)); });
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(1, "p-button", 6);
    i0.ɵɵlistener("click", function WidgetHeaderComponent_ng_template_1_Conditional_0_Template_p_button_click_1_listener() { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(2); return i0.ɵɵresetView(ctx_r1.sidebarVisible = true); });
    i0.ɵɵelementEnd();
} if (rf & 2) {
    i0.ɵɵproperty("outlined", true);
    i0.ɵɵadvance();
...
function WidgetHeaderComponent_ng_template_1_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵconditionalCreate(0, WidgetHeaderComponent_ng_template_1_Conditional_0_Template, 2, 3);
} if (rf & 2) {
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵconditional(ctx_r1.onEditMode ? 0 : -1);
} }
function WidgetHeaderComponent_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵadvance();
    i0.ɵɵtextInterpolate1(" ", ctx_r1.title, " Settings ");
} }
function WidgetHeaderComponent_ng_template_4_Template(rf, ctx) { if (rf & 1) {
    const _r3 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "vis-widget-config", 8);
    i0.ɵɵlistener("onUpdate", function WidgetHeaderComponent_ng_template_4_Template_vis_widget_config_onUpdate_0_listener($event) { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.onUpdateOptions($event)); });
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵproperty("selectedDashboardId", ctx_r1.dashboardId)("widget", ctx_r1.widget);
} }
class WidgetHeaderComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: WidgetHeaderComponent, selectors: [["vis-widget-header"]], inputs: { widget: "widget", onEditMode: "onEditMode", dashboardId: "dashboardId" }, outputs: { onUpdateWidget: "onUpdateWidget", onDeleteWidget: "onDeleteWidget" }, decls: 5, vars: 6, consts: [[3, "header"], ["pTemplate", "icons"], ["position", "right", "model", "false", 3, "visibleChange", "visible", "appendTo"], ["pTemplate", "header"], ["pTemplate", "content"], ["type", "button", "icon", "pi pi-trash", 1, "p-button-sm", "mr-2", 3, "click", "outlined"], ["type", "button", "icon", "pi pi-cog", 1, "p-button-sm", 3, "click", "outlined"], [1, "font-bold", "ml-3", "mb-3", "text-lg"], [3, "onUpdate", "selectedDashboardId", "widget"]], template: function WidgetHeaderComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            SidebarModule, i1$2.Sidebar, i2$1.PrimeTemplate, PanelModule, i3$1.Panel, WidgetConfigComponent,
            ButtonModule, i2.Button], styles: [".panel-button[_ngcontent-%COMP%]{display:flex;flex-direction:row;justify-content:end}[_nghost-%COMP%]     .p-panel .p-panel-content{display:none}"] }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(WidgetHeaderComponent, { className: "WidgetHeaderComponent", filePath: "lib/widget-header/widget-header.component.ts", lineNumber: 22 }); })();
...
class DashboardContainerComponent {
    constructor() {
        this.filterValues = [];
        this.container = DashboardContainerComponent;
    ...
    getEditModeString(editModeString) {
        // this.editModeStringChange.emit(editModeString)
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(DashboardContainerComponent, { className: "DashboardContainerComponent", filePath: "lib/dashboard-container/dashboard-container.component.ts", lineNumber: 53 }); })();
